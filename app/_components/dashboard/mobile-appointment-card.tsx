        ...
        <div className={`p-4 border border-[#1f1f1f] rounded-lg mb-3 transition-all ${
            ...
            <div className="flex items-start justify-between mb-3">
                <div className="flex items-center gap-3 flex-1">
                    <Checkbox
                        id={`select-mobile-${appointment.id}`}
            ...
            <div className="space-y-2">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-white text-sm font-medium">{appointment.type}</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <span className="text-white text-sm">R$ {appointment.totalValue.toFixed(2)}</span>
                    </div>
                </div>
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        <Clock className="h-4 w-4 text-slate-400" />
                        <span className="text-slate-400 text-sm">{appointment.duration}min</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <CalendarIcon className="h-4 w-4 text-slate-400" />
                        <span className="text-slate-400 text-sm">{appointment.date.split(' - ')[0]}</span>
                    </div>
                </div>
                ...
                <div className="pt-2 border-t border-[#1f1f1f]">
                    ...
                    <span className="text-white text-sm">{appointment.employee}</span>
                </div>
