        ...
        <Card className=" border-[#333]">
          ...
          <CardContent className="space-y-6">
              ...
              <TabsContent value="terms" className="mt-4 space-y-4">
                ...
                <div className="flex items-center gap-2">
                  <Button
                    ...
                    className={
                      acceptedTerms ? 'bg-[#8161FF] hover:bg-[#7050e0]' : ''
                    }
                  >
              ...
              <TabsContent value="privacy" className="mt-4 space-y-4">
                ...
                <div className="flex items-center gap-2">
                  <Button
                    ...
                    className={
                      acceptedPrivacy ? 'bg-[#8161FF] hover:bg-[#7050e0]' : ''
                    }
                  >
                    <CheckCircle2 className="h-4 w-4 mr-2" />
                    Aceito
              ...
              <TabsContent value="lgpd" className="mt-4 space-y-4">
                ...
                <div className="flex items-center gap-2">
                  <Button
                    ...
                    className={
                      acceptedLGPD ? 'bg-[#8161FF] hover:bg-[#7050e0]' : ''
                    }
                  >
                    <CheckCircle2 className="h-4 w-4 mr-2" />
                    Aceito
            ...
            <div className="flex justify-between items-center pt-4 border-t border-[#333]">
              <p
                className={`text-sm ${allAccepted ? 'text-green-400' : 'text-red-400'}`}
              >
                {allAccepted
                  ? '✅ Todos os documentos foram aceitos.'
                  : '⚠️ Você precisa aceitar todos os documentos.'}
              </p>
              <Button
